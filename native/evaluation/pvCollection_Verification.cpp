...
{ 
    ...
    int it = 0;
    //// Participant uses true histogram
	...
	if (argc > 1)
	{
		...
		{
			fout.open("./results/test_PV_verification_500K_eta_005_permutation_coefficient_a_3_10runs.csv", ios::out | ios::trunc);
		...
		{
			fout.open("./results/test_PV_verification_500K_eta_005_permutation_coefficient_a_3_10runs.csv", ios::out | ios::app);
		}
